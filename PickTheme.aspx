<%@ Page Title="Pick Your Theme" Language="C#" MasterPageFile="~/MasterPickThemes.Master" AutoEventWireup="true" CodeBehind="PickTheme.aspx.cs" Inherits="WebProjectNew.PickTheme" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .themes-wrapper { text-align: center; padding: 40px; background-color: #F4F7FC; }
        .page-title { color: #70677A; font-size: 28px; margin-bottom: 30px; font-weight: 500; }
        ...
        .btn-details { 
            background-color: #C4C4C4; color: white !important; padding: 10px; 
            width: 100%; border-radius: 15px; text-decoration: none; 
            display: block; margin-bottom: 10px; font-size: 14px; border: none; 
            box-sizing: border-box; cursor: pointer;
        }
        .btn-details:hover { background-color: #b0b0b0; }

        .btn-book { 
            background-color: #70677A; color: white; padding: 12px; 
            width: 100%; border-radius: 15px; border: none; cursor: pointer; 
