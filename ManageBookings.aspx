...
<div style="width:1000px;margin:auto;background:white;padding:20px;">
    ...
    <div style="background:#5e5a6e;color:white;
        font-size:38px;font-family:Georgia;padding:15px;">
        Manage Booking
    </div>

    <table style="width:100%;border-collapse:collapse;text-align:center;font-family:Georgia;">

        <tr style="background:white;height:60px;font-size:18px;font-weight:bold;">
            <td>Client Name</td>
            <td>Theme Date</td>
            <td>Time</td>
            <td>Status</td>
        ...
        <tr style="background:#5e5a6e;height:100px;color:white;">
            ...
            <td>
                <asp:TextBox ID="txtClientName" runat="server" Width="170px" Height="30px"></asp:TextBox>
                <br />
            ...
            <td>
                <asp:TextBox ID="txtThemeDate" runat="server" TextMode="Date" Width="150px" Height="30px"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="rfvThemeDate" runat="server"
            ...
            <td>
                <asp:DropDownList ID="ddlTime" runat="server" Width="120px" Height="35px">
            ...
            <td>
                <asp:DropDownList ID="ddlStatus" runat="server" Width="130px" Height="35px">
                    <asp:ListItem Text="Select" Value=""></asp:ListItem>
